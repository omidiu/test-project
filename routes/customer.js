...
// Add customer
router.post('/signup', 
customerValidator.isValidRegisterForm, 
customerController.create);


// login customer
router.post('/login', 
customerValidator.isValidloginForm, 
...
router.put('/profile', 
passport.authenticate('customer', {session: false}), 
customerValidator.isValidEditForm, 
...
passport.authenticate('customer', {session: false}), 
customerValidator.isValidItem, 
customerController.addItemToShoppingCart);
...
router.put('/shopping-carts/:itemId', 
passport.authenticate('customer', {session: false}), 
customerValidator.isValidEditItem, 
customerController.editItemOfShoppingCart);



// Delete shopping cart item
router.delete('/shopping-carts/:itemId', 
passport.authenticate('customer', {session: false}), 
